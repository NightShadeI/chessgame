...
PositiveDiagonalPropagator::PositiveDiagonalPropagator(Piece* rootPiece, Move* movePerformed) : Propagator(rootPiece, movePerformed) {
}

void PositiveDiagonalPropagator::openPropagation(Game& game) {
...
void PositiveDiagonalPropagator::closePropagation(Game& game) {
    int oldXDistance = movePerformed->xFrom - rootPiece->xPos;
    int oldYDistance = movePerformed->yFrom - rootPiece->yPos;
    int newXDistance = movePerformed->xTo - rootPiece->xPos;
    int newYDistance = movePerformed->yTo - rootPiece->yPos;
